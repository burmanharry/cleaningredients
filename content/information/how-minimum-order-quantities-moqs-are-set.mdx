---
title: "How minimum order quantities (MOQs) are set."
description: "How minimum order quantities (MOQs) are set. — practical definitions, checklists, and what to ask suppliers."
